...
describe('contributing() contributing method', () => {
  ...
  describe("Edge Cases", () => {
    it("should return error status when contributing guide is absent", () => {
      ...
      expect(result.description).toBe("You do not have a contributing guide in your repo.");
      expect(result.extra).toBe("This is important, so people know how to get started with your project.");
    });
