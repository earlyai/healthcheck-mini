...
describe('issueTemplates() issueTemplates method', () => {
  // Happy Path Tests
  describe('Happy Path', () => {
    it('should return success response when issue_template file exists', () => {
  ...
  // Edge Case Tests
  describe('Edge Cases', () => {
    it('should return error response when issue_template file does not exist', () => {
    ...
    it('should return error response when files object is empty', () => {
    ...
    it('should return error response when files object is undefined', () => {
